...
class Node:
    ...
    """
    def __init__(self, name: str, demand: float, t_w: Tuple[float]):
        if t_w[0] > t_w[1]:
...
class VehicleRoutingProblemWithTimeWindows:
    ...
    VehicleRoutingProblemWithTimeWindows Routing Problem with Time Windows (VRPTW)
    ...
    def __str__(self):
        ...
        full_str += f"VehicleRoutingProblemWithTimeWindows Capacity: {self.vehicle_cap}\n"
